...
class _Config:
    ...
    # #     self.save_log = True
    # #     self._init_logging_handler(log_dir)


    # def init_handler(self, dataset='multiwoz', log_dir = './log'):
    #     init_method = {
    #         'multiwoz':self._multiwoz_init,
    #         'schema':self._schema_init
    #     }
    #     init_method[dataset](log_dir)

    def _multiwoz_init(self):
        self.vocab_path_train = './data/multi-woz-processed/vocab'
        self.vocab_path_eval = None
        self.data_path = './data/multi-woz-processed/adapt_9_old/'
    ...
    def _schema_init(self):
        ...
        self.vocab_path_train = './data/schema/vocab'
        self.vocab_path_eval = None
        self.data_path = './data/schema/'
        ...
        self.target_domain = 'restaurants_1'
        self.train_data_file = ['data_in_domain_' + domain + '.json' for domain in self.source_domain]
        self.adapt_data_file = 'adapt_data_in_domain_' + self.target_domain + '.json'
        self.test_data_file = 'test_data_in_domain_' + self.target_domain + '.json'
        ...
        # }
        self.glove_path = './data/glove/glove.6B.50d.txt'
        self.domain_file_path = 'data/schema/domain_files.json'
        self.slot_value_set_path = 'data/schema/db/value_set.json'
        # self.multi_acts_path = 'data/multi-woz-processed/multi_act_mapping_train.json'
        self.exp_path = '' #'to be generated'
        self.log_time = time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime())
        self.spv_proportion = 100
...
# multiwoz_config = _Config()
# schema_config   = _Config(dataset='schema')
